                    ...
                    <div className="boxes-title">
                        {
                            titleData !== undefined && titleData !== 'null' ?
                                titleData.map(title => {
                                    return <p key={uuid()}>
                                        x: {Math.round(title[0])}, y: {Math.round(title[1])}, height: {Math.round(title[3])}, width: {Math.round(title[2])} <i>Title</i>
                                    </p>;
                                })
                                :
                                null
                    ...
                    <div className='boxes-author'>
                        {
                            authorData !== undefined && authorData !== 'null' ?
                                authorData.map(author => {
                                    return <p key={uuid()}>
                                        x: {Math.round(author[0])}, y: {Math.round(author[1])}, height: {Math.round(author[3])}, width: {Math.round(author[2])} <i>Author</i>
                                    </p>;
                                })
                                :
                                null
